...
int main()
{
	...
	{2};}} | {IF:{EQUALS:{IPV4_SOURCE_ADDRESS},{192.168.001.037};};{IPV4_SOURCE_ADDRESS{LEADING:{ },{15};}}}{IF:
	{EQUALS:{IPV4_DESTINATION_ADDRESS},{192.168.001.037};};{IPV4_DESTINATION_ADDRESS{LEADING:{ },{15};}}}:{IF:
	{EQUALS:{IPV4_SOURCE_ADDRESS},{192.168.001.037};};{TCP_SOURCE_PORT{LEADING:{0},{5};}}}{IF:{EQUALS:
	{IPV4_DESTINATION_ADDRESS},{192.168.001.037};};{TCP_DESTINATION_PORT{LEADING:{0},{5};}}} {IF:{EQUALS:
	{IPV4_SOURCE_ADDRESS},{192.168.001.037};};{-->}}{IF:{EQUALS:{IPV4_DESTINATION_ADDRESS},{192.168.001.037};};
	{<--}} {IF:{EQUALS:{IPV4_SOURCE_ADDRESS},{192.168.001.037};};{IPV4_DESTINATION_ADDRESS{LEADING:{ },{15};}}}
	{IF:{EQUALS:{IPV4_DESTINATION_ADDRESS},{192.168.001.037};};{IPV4_SOURCE_ADDRESS{LEADING:{ },{15};}}}:{IF:
	{EQUALS:{IPV4_SOURCE_ADDRESS},{192.168.001.037};};{TCP_DESTINATION_PORT{LEADING:{0},{5};}}}{IF:{EQUALS:
	{IPV4_DESTINATION_ADDRESS},{192.168.001.037};};{TCP_SOURCE_PORT{LEADING:{0},{5};}}} | {TCP_PAYLOAD_LENGTH
	{LEADING:{0},{5};}} | {IF:{EQUALS:{IPV4_SOURCE_ADDRESS},{192.168.001.037};};{A}}{IF:{EQUALS:
	{IPV4_DESTINATION_ADDRESS},{192.168.001.037};};{S}}{IF:{EQUALS:{IPV4_SOURCE_ADDRESS},{192.168.001.037};};
	{TCP_ACKNOWLEDGEMENT_NUMBER{LEADING:{0},{10};}}}{IF:{EQUALS:{IPV4_DESTINATION_ADDRESS},{192.168.001.037};};
	{TCP_SEQUENCE_NUMBER{LEADING:{0},{10};}}} - {IF:{EQUALS:{IPV4_SOURCE_ADDRESS},{192.168.001.037};};
	{TCP_SEQUENCE_NUMBER{LEADING:{0},{10};}}}{IF:{EQUALS:{IPV4_DESTINATION_ADDRESS},{192.168.001.037};};
	{TCP_ACKNOWLEDGEMENT_NUMBER{LEADING:{0},{10};}}}{IF:{EQUALS:{IPV4_SOURCE_ADDRESS},{192.168.001.037};};
	{S}}{IF:{EQUALS:{IPV4_DESTINATION_ADDRESS},{192.168.001.037};};{A}} | {IF:{EQUALS:{TCP_FLAGS_FIN},{0};};
	{-}}{IF:{EQUALS:{TCP_FLAGS_FIN},{1};};{F}}{IF:{EQUALS:{TCP_FLAGS_SYN},{0};};{-}}{IF:{EQUALS:{TCP_FLAGS_SYN},
	{1};};{S}}{IF:{EQUALS:{TCP_FLAGS_RST},{0};};{-}}{IF:{EQUALS:{TCP_FLAGS_RST},{1};};{R}}{IF:{EQUALS:
	{TCP_FLAGS_PSH},{0};};{-}}{IF:{EQUALS:{TCP_FLAGS_PSH},{1};};{P}}{IF:{EQUALS:{TCP_FLAGS_ACK},{0};};{-}}
	{IF:{EQUALS:{TCP_FLAGS_ACK},{1};};{A}}{IF:{EQUALS:{TCP_FLAGS_URG},{0};};{-}}{IF:{EQUALS:{TCP_FLAGS_URG},
	{1};};{U}}{IF:{EQUALS:{TCP_FLAGS_ECE},{0};};{-}}{IF:{EQUALS:{TCP_FLAGS_ECE},{1};};{E}}{IF:{EQUALS:
	{TCP_FLAGS_CWR},{0};};{-}}{IF:{EQUALS:{TCP_FLAGS_CWR},{1};};{C}} |\n", "{AND:{NOT:{EQUALS:{ETHERNET},
	{0};};},{NOT:{EQUALS:{IPV4},{0};};},{NOT:{EQUALS:{TCP},{0};};};}");
